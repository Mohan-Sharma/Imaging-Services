...
public class Roles {
	...
	public static final long RADIOLOGIST = 			0x0000008000000000l; // 549755813888
	...
	public static final long[] PRACTICE_DEPENDENT_ROLES = 
		new long[]{ADMIN, PROVIDER, MEDICAL_ASSISTANT, PATIENT, NURSE, BILLING, CASE_MANAGER, RECEPTION, RADIOLOGIST, STORE_MANAGEMENT,HOUSE_KEEPING,ORDER_MANAGEMENT,PHLEBOTOMIST};
	...
	static {
		...
		ROLENAMEANDVALUEMAP.put("RADIOLOGIST", RADIOLOGIST);
		...
		ROLEVALUEANDNAMEMAP.put(RADIOLOGIST , "RADIOLOGIST");
